...
`.trim();
  ...
  systemParts.push(
    ...
    '- NEVER EVER use: "Research", "Misc", "Other", "General", "Uncategorized", "Unknown", "Tools"',
    "- DISCOURAGED but allowed: Utilities (prefer more specific categories when possible)",
    "- ALWAYS choose from: Email, Work, Development, Shopping, Entertainment, Social, News, Finance, Travel, AI, Utilities",
    "- For unclear cases: Work (general productivity), Development (technical), Finance (money-related), or Utilities (security/system tools only)",
    "",
